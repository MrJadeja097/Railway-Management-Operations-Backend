...
@ApiBadRequestResponse({ description: `Invalid data provided for train creation.` })
@ApiUnauthorizedResponse({ description: `Unauthorized. Valid access token is required.` })
@ApiInternalServerErrorResponse({ description: `Unexpected error occurred while creating train.` })
...
@ApiUnauthorizedResponse({ description: `Unauthorized. Valid access token is required.` })
@ApiInternalServerErrorResponse({ description: `Error occurred while retrieving train data.` })
...
@ApiNotFoundResponse({ description: `No trains found with the provided name.` })
@ApiUnauthorizedResponse({ description: `Unauthorized. Valid access token is required.` })
@ApiInternalServerErrorResponse({ description: `Failed to search trains due to server error.` })
...
@ApiUnauthorizedResponse({ description: `Unauthorized. Valid access token is required.` })
@ApiInternalServerErrorResponse({ description: `Unexpected error occurred while retrieving the train.` })
...
@ApiBadRequestResponse({ description: `Invalid data provided for train update.` })
@ApiNotFoundResponse({ description: `Train not found with the given ID.` })
@ApiUnauthorizedResponse({ description: `Unauthorized. Valid access token is required.` })
@ApiInternalServerErrorResponse({ description: `Failed to update train due to server error.` })
...
@ApiUnauthorizedResponse({ description: `Unauthorized. Valid access token is required.` })
@ApiInternalServerErrorResponse({ description: `An error occurred while deleting the train.` })
